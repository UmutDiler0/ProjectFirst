...
import com.example.projectfirst.databinding.FragmentGivingBinding
...
class GivingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bottomNav!!.setBackgroundColor(ContextCompat.getColor(requireContext(),R.color.givingColor2))
    }
